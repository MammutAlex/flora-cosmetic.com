...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-110865984-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-110865984-1');
    </script>
</head>
<body>
...
<nav class="navbar navbar-default navbar-static-top yamm sticky-header">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/"><img src="/images/logo3.png" style="height: 30px" alt=""></a>
        </div>
        ...
        <div class="row">
            <div class="col-md-3 margin-b-30">
                ...
                <p>
                    ...
                    готовится индивидуально,<br>
                    из природных компонентов,<br>
                    бережно ухаживает <br>
                    за кожей и волосами<br>
                    Попробуйте, чтоб убедились сами!<br>
                    С любовью, ФЛОРА
                </p>
