        ...
        <div class="row">
            <div class="col-md-3 margin-b-30">
                ...
                <p>
                    ...
                    готовится индивидуально,
                    из лучших природных компонентов,
                    которые бережно ухаживают за лицом,
                    телом и волосами, <br>
                    давая заметный результат - без привыкания! 
                    Попробуйте, что б убедиться самим!<br>
                    С любовью, ФЛОРА
                </p>
